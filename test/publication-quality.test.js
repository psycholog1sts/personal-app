...
import { buildAbsoluteUrl } from '../i18n/seo.js';
...
test('root layout owns shared shell only and exposes a keyboard skip link', async () => {
...
test('publication metadata includes local brand icons and social preview generators', async () => {
  for (const path of ['app/icon.js', 'app/opengraph-image.js', 'app/twitter-image.js']) {
