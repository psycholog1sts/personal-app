...
export default function PrivacyPage() {
  return (
    <main className="shell legal">
      ...
      <p>RLSProof Quick Scan accepts a public GitHub repository identifier, requests a bounded set of eligible public source files from GitHub, scans them in a temporary directory, returns normalized findings, and deletes the temporary directory after the request completes.</p>
      ...
      <p>GitHub receives the repository API requests needed to retrieve public content. If you purchase a paid service, the payment provider receives the information necessary to process that transaction. RLSProof does not use a paid AI model for the free scan.</p>
      <h2>Limits</h2>
