...
export default function TermsPage() {
  return (
    <main className="shell legal">
      ...
      <p>RLSProof is an engineering aid. A clean result does not prove that software is secure, compliant, free of vulnerabilities, or safe to deploy. Quick Scan intentionally performs partial static checks and marks its coverage incomplete.</p>
      <h2>Paid services</h2>
      ...
      <p>Do not use RLSProof to access private systems without authorization, expose credentials, evade access controls, or perform harmful activity.</p>
